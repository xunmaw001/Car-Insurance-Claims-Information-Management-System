    ...
    */
    ...
    public R save(@RequestBody YuangongEntity yuangong, HttpServletRequest request){
        ...
        if(yuangongEntity==null){
            ...
            return R.error(511,"账户或者事故调查员手机号或者事故调查员身份证号已经被使用");
        }
    }
...
//                            yuangongEntity.setYuangongUuidNumber(data.get(0));                    //事故调查员编号 要改的
//                            yuangongEntity.setYuangongName(data.get(0));                    //事故调查员姓名 要改的
//                            yuangongEntity.setYuangongPhone(data.get(0));                    //事故调查员手机号 要改的
//                            yuangongEntity.setYuangongIdNumber(data.get(0));                    //事故调查员身份证号 要改的
//                            yuangongEntity.setYuangongPhoto("");//详情和图片
//                            yuangongEntity.setSexTypes(Integer.valueOf(data.get(0)));   //性别 要改的
//                            yuangongEntity.setYuangongEmail(data.get(0));                    //事故调查员邮箱 要改的
//                            yuangongEntity.setCreateTime(date);//时间
                        ...
                        if(yuangongEntities_yuangongUuidNumber.size() >0 ){
                            ...
                            return R.error(511,"数据库的该表中的 [事故调查员编号] 字段已经存在 存在数据为:"+repeatFields.toString());
                        }
                         //事故调查员手机号
                        ...
                        if(yuangongEntities_yuangongPhone.size() >0 ){
                            ...
                            return R.error(511,"数据库的该表中的 [事故调查员手机号] 字段已经存在 存在数据为:"+repeatFields.toString());
                        }
                         //事故调查员身份证号
                        ...
                        if(yuangongEntities_yuangongIdNumber.size() >0 ){
                            ...
                            return R.error(511,"数据库的该表中的 [事故调查员身份证号] 字段已经存在 存在数据为:"+repeatFields.toString());
                        }
    ...
    */
    ...
    public R login(String username, String password, String captcha, HttpServletRequest request) {
        ...
        String token = tokenService.generateToken(yuangong.getId(),username, "yuangong", "事故调查员");
        R r = R.ok();
        r.put("token", token);
        r.put("role","事故调查员");
...
//    	ValidatorUtils.validateEntity(user);
        ...
        YuangongEntity yuangongEntity = yuangongService.selectOne(queryWrapper);
        if(yuangongEntity != null)
            return R.error("账户或者事故调查员手机号或者事故调查员身份证号已经被使用");
