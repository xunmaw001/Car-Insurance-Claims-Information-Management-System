...
public class DiaochaYuyueView extends DiaochaYuyueEntity implements Serializable {
	...
	*/
	...
	private String diaochaYuyueYesnoValue;
	...
	public DiaochaYuyueView() {

	}

	public DiaochaYuyueView(DiaochaYuyueEntity diaochaYuyueEntity) {
		try {
			BeanUtils.copyProperties(this, diaochaYuyueEntity);
	...
	* 获取： 报名状态的值
	*/
	public String getDiaochaYuyueYesnoValue() {
		return diaochaYuyueYesnoValue;
	}
	/**
	* 设置： 报名状态的值
	*/
	public void setDiaochaYuyueYesnoValue(String diaochaYuyueYesnoValue) {
		this.diaochaYuyueYesnoValue = diaochaYuyueYesnoValue;
	}
	...
	public String toString() {
		return "DiaochaYuyueView{" +
			", diaochaYuyueYesnoValue=" + diaochaYuyueYesnoValue +
