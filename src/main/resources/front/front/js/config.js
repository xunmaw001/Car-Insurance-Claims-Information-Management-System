...
var centerMenu = [
    ...
    ,{
        name: '保险订单',
        url: '../baoxianOrder/list.html'
    }
    ,{
        name: '调查申请',
        url: '../diaochaYuyue/list.html'
    }
    ,{
        name: '事故调查',
        url: '../shigu/list2.html'
    }
    ,{
        name: '现场勘查',
        url: '../xianchang/list2.html'
    }
    ,{
        name: '理赔申请',
        url: '../shiguYuyue/list.html'
    }
...
// 已废弃,不用了
var adminurl =  "http://localhost:8080/chexianlipeixinxiguanlixitong/admin/dist/index.html#/login";
