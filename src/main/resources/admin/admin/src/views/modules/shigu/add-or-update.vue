               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="事故调查名称" prop="shiguName">
                       <el-input v-model="ruleForm.shiguName"
                                 placeholder="事故调查名称" clearable  :readonly="ro.shiguName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="事故调查编号" prop="shiguUuidNumber">
                       <el-input v-model="ruleForm.shiguUuidNumber"
                                 placeholder="事故调查编号" clearable  :readonly="ro.shiguUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                ...
                <el-col :span="12">
                    <el-form-item class="upload" v-if="type!='info' && !ro.shiguPhoto" label="事故调查照片" prop="shiguPhoto">
                        <file-upload
                            ...
                            :limit="3"
                            :multiple="true"
                            :fileUrls="ruleForm.shiguPhoto?$base.url+ruleForm.shiguPhoto:''"
                            @change="shiguPhotoUploadChange"
                        ></file-upload>
                    </el-form-item>
                    <div v-else>
                ...
                <el-col :span="12">
                    <el-form-item class="upload" v-if="type!='info' && !ro.shiguFile" label="文件" prop="shiguFile">
                        <file-upload
                                tip="点击上传文件"
                                action="file/upload"
                                :limit="3"
                                :multiple="true"
                                :fileUrls="ruleForm.shiguFile?$base.url+ruleForm.shiguFile:''"
                                @change="shiguFileUploadChange"
                        ></file-upload>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.shiguFile" label="文件" prop="shiguFile">
                            <a type="text" style="text-decoration:none" class="el-button" :href="$base.url+ruleForm.shiguFile"  >文件下载</a>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="事故调查类型" prop="shiguTypes">
                        <el-select v-model="ruleForm.shiguTypes" :disabled="ro.shiguTypes" placeholder="请选择事故调查类型">
                            <el-option
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info' && !ro.shiguContent"  label="事故调查介绍" prop="shiguContent">
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.shiguContent" label="事故调查介绍" prop="shiguContent">
...
<script>
    ...
    export default {
        data() {
            return {
                ...
                ruleForm: {
                    ...
                    yuangongId: '',
                    shiguName: '',
                    shiguUuidNumber: new Date().getTime(),
                    shiguPhoto: '',
                    shiguFile: '',
                    shiguTypes: '',
                    shiguContent: '',
                ...
                rules: {
                   ...
                   shiguName: [
                              { required: true, message: '事故调查名称不能为空', trigger: 'blur' },
                          ],
                   shiguUuidNumber: [
                              { required: true, message: '事故调查编号不能为空', trigger: 'blur' },
                          ],
                   shiguPhoto: [
                              { required: true, message: '事故调查照片不能为空', trigger: 'blur' },
                          ],
                   shiguFile: [
                              { required: true, message: '文件不能为空', trigger: 'blur' },
                          ],
                   shiguTypes: [
                              { required: true, message: '事故调查类型不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
                   ...
                   shiguContent: [
                              { required: true, message: '事故调查介绍不能为空', trigger: 'blur' },
                          ],
                   shiguDelete: [
        ...
        methods: {
            ...
            //图片
            shiguPhotoUploadChange(fileUrls){
                this.ruleForm.shiguPhoto = fileUrls;
                this.addEditUploadStyleChange()
            },
            shiguFileUploadChange(fileUrls){
                this.ruleForm.shiguFile = fileUrls;
                this.addEditUploadStyleChange()
            },
