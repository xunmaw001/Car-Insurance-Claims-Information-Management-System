    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="报名编号" prop="diaochaYuyueUuidNumber">
                       <el-input v-model="ruleForm.diaochaYuyueUuidNumber"
                                 placeholder="报名编号" clearable  :readonly="ro.diaochaYuyueUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="报名编号" prop="diaochaYuyueUuidNumber">
                           <el-input v-model="ruleForm.diaochaYuyueUuidNumber"
            ...
            <input id="yuangongId" name="yuangongId" type="hidden">
                <el-col :span="12">
                    <el-form-item v-if="type!='info' && !ro.diaochaYuyueTime"  class="input" label="时间" prop="diaochaYuyueTime">
                        <el-date-picker
                                value-format="yyyy-MM-dd HH:mm:ss"
                                v-model="ruleForm.diaochaYuyueTime"
                                type="datetime"
                                placeholder="时间"
                                :disabled="ro.diaochaYuyueTime">
                        </el-date-picker>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.diaochaYuyueTime" label="时间" prop="diaochaYuyueTime">
                            <span v-html="ruleForm.diaochaYuyueTime"></span>
                        </el-form-item>
                    </div>
                </el-col>

               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="地点" prop="diaochaYuyueAddress">
                       <el-input v-model="ruleForm.diaochaYuyueAddress"
                                 placeholder="地点" clearable  :readonly="ro.diaochaYuyueAddress"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="地点" prop="diaochaYuyueAddress">
                           <el-input v-model="ruleForm.diaochaYuyueAddress"
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="严重程度" prop="diaochaYuyueCehngdu">
                       <el-input v-model="ruleForm.diaochaYuyueCehngdu"
                                 placeholder="严重程度" clearable  :readonly="ro.diaochaYuyueCehngdu"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="严重程度" prop="diaochaYuyueCehngdu">
                           <el-input v-model="ruleForm.diaochaYuyueCehngdu"
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="理由" prop="diaochaYuyueText">
                        <el-input type="textarea"  :readonly="ro.diaochaYuyueText" v-model="ruleForm.diaochaYuyueText" placeholder="理由"></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.diaochaYuyueText" label="理由" prop="diaochaYuyueText">
                            <span v-html="ruleForm.diaochaYuyueText"></span>
                        </el-form-item>
                    </div>
                </el-col>
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.diaochaYuyueYesnoTypes" label="报名状态" prop="diaochaYuyueYesnoTypes">
                        <el-input v-model="ruleForm.diaochaYuyueYesnoValue" placeholder="报名状态" readonly></el-input>
                    </el-form-item>
                </div>
            </el-col>
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.diaochaYuyueYesnoText" label="审核回复" prop="diaochaYuyueYesnoText">
                        <span v-html="ruleForm.diaochaYuyueYesnoText"></span>
                    </el-form-item>
                </div>
            </el-col>
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.diaochaYuyueShenheTime" label="审核时间" prop="diaochaYuyueShenheTime">
                        <span v-html="ruleForm.diaochaYuyueShenheTime"></span>
                    </el-form-item>
                </div>
            </el-col>
            </el-row>
    ...
    export default {
        data() {
            return {
                ...
                yuangongForm: {},
                ro:{
                    diaochaYuyueUuidNumber: true,
                    yonghuId: false,
                    yuangongId: false,
                    diaochaYuyueTime: false,
                    diaochaYuyueAddress: false,
                    diaochaYuyueCehngdu: false,
                    diaochaYuyueText: false,
                    insertTime: false,
                    diaochaYuyueYesnoTypes: false,
                    diaochaYuyueYesnoText: false,
                    diaochaYuyueShenheTime: false,
                },
                ruleForm: {
                    diaochaYuyueUuidNumber: new Date().getTime(),
                    yonghuId: '',
                    yuangongId: '',
                    diaochaYuyueTime: '',
                    diaochaYuyueAddress: '',
                    ...
                    diaochaYuyueText: '',
                    insertTime: '',
                    diaochaYuyueYesnoTypes: '',
                    diaochaYuyueYesnoText: '',
                    diaochaYuyueShenheTime: '',
                },
                diaochaYuyueYesnoTypesOptions : [],
                yonghuOptions : [],
                yuangongOptions : [],
                rules: {
                   diaochaYuyueUuidNumber: [
                   ...
                   insertTime: [
                              { required: true, message: '调查申请时间不能为空', trigger: 'blur' },
                          ],
                   diaochaYuyueYesnoTypes: [
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=diaocha_yuyue_yesno_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.diaochaYuyueYesnoTypesOptions = data.data.list;
                    }
                });
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`diaochaYuyue/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.diaochaYuyueCrossAddOrUpdateFlag = false;
                                        this.parent.search();
