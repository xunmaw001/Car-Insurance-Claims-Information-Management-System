               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="事故调查员编号" prop="yuangongUuidNumber">
                       <el-input v-model="ruleForm.yuangongUuidNumber"
                                 placeholder="事故调查员编号" clearable  :readonly="ro.yuangongUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="事故调查员姓名" prop="yuangongName">
                       <el-input v-model="ruleForm.yuangongName"
                                 placeholder="事故调查员姓名" clearable  :readonly="ro.yuangongName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="事故调查员手机号" prop="yuangongPhone">
                       <el-input v-model="ruleForm.yuangongPhone"
                                 placeholder="事故调查员手机号" clearable  :readonly="ro.yuangongPhone"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="事故调查员身份证号" prop="yuangongIdNumber">
                       <el-input v-model="ruleForm.yuangongIdNumber"
                                 placeholder="事故调查员身份证号" clearable  :readonly="ro.yuangongIdNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="事故调查员邮箱" prop="yuangongEmail">
                       <el-input v-model="ruleForm.yuangongEmail"
                                 placeholder="事故调查员邮箱" clearable  :readonly="ro.yuangongEmail"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   yuangongUuidNumber: [
                              { required: true, message: '事故调查员编号不能为空', trigger: 'blur' },
                          ],
                   yuangongName: [
                              { required: true, message: '事故调查员姓名不能为空', trigger: 'blur' },
                          ],
                   yuangongPhone: [
                              {  required: true, message: '事故调查员手机号不能为空', trigger: 'blur' },
                              {  pattern: /^(13[0-9]|14[01456879]|15[0-35-9]|16[2567]|17[0-8]|18[0-9]|19[0-35-9])\d{8}$/,
                                 message: '事故调查员手机号格式不对',
                                 trigger: 'blur'
                              }
                          ],
                   yuangongIdNumber: [
                              { required: true, message: '事故调查员身份证号不能为空', trigger: 'blur' },
                              { pattern: /^[1-9]\d{5}(18|19|([23]\d))\d{2}((0[1-9])|(10|11|12))(([0-2][1-9])|10|20|30|31)\d{3}[0-9Xx]$/,
                                message: '事故调查员身份证号格式有误！',
                                trigger: 'blur'
                              }
                          ],
                   yuangongPhoto: [
                              { required: true, message: '事故调查员头像不能为空', trigger: 'blur' },
                          ],
                   sexTypes: [
                   ...
                   yuangongEmail: [
                              { required: true, message: '事故调查员邮箱不能为空', trigger: 'blur' },
                              { pattern: /^([a-zA-Z0-9_-])+@([a-zA-Z0-9_-])+(.[a-zA-Z0-9_-])+/,
                                message: '事故调查员邮箱只能是邮箱格式',
                                trigger: 'blur'
                              }
                          ],
                }
